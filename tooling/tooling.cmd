...
@REM To install Visual Studio Code extensions during setup, the "code" executable is used. The extensions can be configured by editing the "vscode_extensions.txt" file
